    ...
    def _from_object(cls, obj: 'terrarun.models.state_version.StateVersion', effective_user: "terrarun.models.user.User"):
        ...
        return cls(
            ...
            attributes={
                ...
                "hosted_json_state_download_url": obj.get_state_json_download_url(effective_user=effective_user),
                "hosted_state_upload_url": obj.get_state_upload_url(effective_user=effective_user),
                "hosted_json_state_upload_url": obj.get_state_json_upload_url(effective_user=effective_user),
