...
def upgrade() -> None:
    ...
    op.create_table('blob',
        ...
        sa.Column('data', sa.LargeBinary(length=((2**20) * 200)), nullable=True),
    ...
    # Add foreign key to lifecycle after creation of organisation table
    with op.batch_alter_table('lifecycle') as lifecycle_batch:
        lifecycle_batch.create_foreign_key('fk_lifecycle_organisation_id_organisation_id', "organisation", ['organisation_id'], ['id'])
