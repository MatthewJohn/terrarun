...
def upgrade() -> None:
    ...
    with op.batch_alter_table('workspace') as workspace_batch:
        ...
        workspace_batch.add_column(sa.Column('project_id', sa.Integer(), nullable=False))
        ...
        workspace_batch.create_foreign_key('workspace_project_id_project_id', 'project', ['project_id'], ['id'])
...
def downgrade() -> None:
    ...
    op.drop_constraint('workspace_project_id_project_id', 'workspace', type_='foreignkey')
