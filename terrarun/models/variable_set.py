...
class VariableSet(Base, BaseObject):
    ...
    api_id_fk = sqlalchemy.Column(sqlalchemy.ForeignKey("api_id.id", name="fk_variable_set_api_id_id"), nullable=True)
    ...
    organisation_id = sqlalchemy.Column(sqlalchemy.ForeignKey("organisation.id", name="variable_set_organisation_organisation_id"), nullable=False)
